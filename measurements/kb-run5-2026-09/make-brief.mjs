 ...
 *
 *   node measurements/kb-run5-2026-09/make-brief.mjs [--base <path>] [--out <file>]
 *
...
const brief = `# Round five — the brief for this session
...
pin says platform \`${pin.platformVersion}\`. Nobody has re-extracted it since the stand moved, so if
