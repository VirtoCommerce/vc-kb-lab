...
| id | subject | confirmations | disputed | scope | also |
|---|---|---|---|---|---|
| [`KB-35A09C64`](captured/KB-35A09C64.md) | `promotion re-evaluation on cart read` | 4 | no | surface=storefront-xapi | cart & checkout |
...
| [`KB-F1542157`](captured/KB-F1542157.md) | `an order-level discount is not allocated to the line items` | 1 | no | surface=admin-ui | orders & shipments |
